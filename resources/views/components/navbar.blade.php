...
<nav class="h-1/5 w-full flex flex-col bg-bgcolor flex">
    <ul class="flex justify-between items-center">
        ...
        <li><a href="{{ route('start')}}"><x-logosmall></x-logosmall></a></li>
...
<section id="mobile-menu" class="absolute bg-bgcolor shadow-lg w-64 top-24 inset-0 z-50 flex flex-col items-beginning">
    <ul class="m-4 flex flex-col">
        <li class="p-2"><button><a class="md:text-lg" href="{{ route('products.index')}}">Alle producten</a></button></li>
        <li class="p-2"><button><a class="md:text-lg" href="{{ route('loaned')}}">Uitgeleende producten</a></button></li>
        <li class="p-2"><button><a class="md:text-lg" href="{{ route('borrowed')}}">Geleende producten</a></button></li>
        <li class="p-2"><button><a class="md:text-lg" href="{{ route('profile')}}">Profiel</a></button></li>
    </ul>
</section>
