...
<nav class="h-1/5 w-full flex flex-col bg-bgcolor flex">
    <ul class="flex justify-between items-center">
        <li  class="pl-6"><button id="toggleMenu"><x-feathericon-menu class="w-8 h-8 md:w-10 md:h-10"></x-feathericon-menu></button></li>
        <li><a href="{{ route('start')}}"><x-logosmall></x-logosmall></a></li>
        <li class="pr-6"><button><a href= "{{ route('profile')}}"><x-feathericon-user class="w-8 h-8 md:w-10 md:h-10"></x-feathericon-user></a></button></li>
    </ul>
...
<section id="mobile-menu" class="absolute bg-bgcolor shadow-lg w-64 top-24 inset-0 z-50 flex flex-col items-beginning">
    ...
    <ul class="m-4 flex flex-col">
        <li class="p-2"><button><a href="{{ route('products.index')}}">Alle producten</a></button></li>
