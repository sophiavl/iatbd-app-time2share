...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="flex justify-center items-center bg-section h-screen">
        <section class="bg-section2 rounded-3xl h-5/6 w-5/6 flex flex-col items-center">
            ...
            <x-button class="w-48 h-9 text-lg xl:w-52 h-20" variant="secondary"  text="Log in" route="login" />
            <x-button class="w-48 h-9 text-lg xl:w-52 h-20" variant="primary" text="Sign up" route="register"/>
            </section>
        </section>
